...
if __name__ == "__main__":
    save_distribution("model_no_pretraining/target_distribution.pkl", target_distribution)
    save_distribution("model_local_no_pretraining/pnumber_distribution.pkl", targetp_distribution)
